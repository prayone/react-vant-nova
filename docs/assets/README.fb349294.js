import{a as d,j as e}from"./main.1e1a3839.js";import{S as r,de as t,cJ as B,ay as C,aI as m}from"./TreeSelect.913ffb06.js";const u=()=>e("div",{style:{width:40,height:40,background:"#f2f3f5",borderRadius:4}});var h=()=>d(r,{gap:20,children:[e(t,{content:5,children:e(u,{})}),e(t,{content:10,children:e(u,{})}),e(t,{content:"hot",children:e(u,{})}),e(t,{dot:!0,children:e(u,{})})]});const f={code:`import React from 'react';
...
`,b={code:E,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Badge, Space } from 'react-vant-nova'
import { Success, Cross, Down } from '@react-vant/icons'
