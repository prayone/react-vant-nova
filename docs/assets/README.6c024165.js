import{j as n,a as t}from"./main.1e1a3839.js";import{ec as e,ad as c,a6 as o,h as d,cF as B}from"./TreeSelect.913ffb06.js";var u=()=>n("div",{className:"demo-action-bar",children:t(e,{children:[n(e.Icon,{icon:n(c,{}),text:"\u5BA2\u670D",onClick:()=>console.log("chat click")}),n(e.Icon,{icon:n(o,{}),text:"\u8D2D\u7269\u8F66",onClick:()=>console.log("cart click")}),n(e.Icon,{icon:n(d,{}),text:"\u5E97\u94FA",onClick:()=>console.log("shop click")}),n(e.Button,{type:"danger",text:"\u7ACB\u5373\u8D2D\u4E70",onClick:()=>console.log("button click")})]})});const A=`import React from 'react'
...
`,p={code:A,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { CartO, ChatO, ShopO } from '@react-vant/icons'
import { ActionBar } from 'react-vant-nova'
...
`,s={code:v,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { CartO, ChatO, ShopO } from '@react-vant/icons'
import { ActionBar } from 'react-vant-nova'
...
`,E={code:m,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { CartO, ChatO, Star } from '@react-vant/icons'
import { ActionBar } from 'react-vant-nova'
...
`,F={code:C,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { CartO, ChatO } from '@react-vant/icons'
import { ActionBar } from 'react-vant-nova'
import './style.less'
