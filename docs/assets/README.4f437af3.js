import{a as t,j as e,r as i,F as E}from"./main.929296ee.js";import{S as m,e6 as o,B as c,dd as a,C as A,dg as D,dq as x,p as P,bG as b,bE as y,dc as h,c0 as g}from"./TreeSelect.6eee9680.js";const p=[{text:"\u9009\u9879\u4E00"},{text:"\u9009\u9879\u4E8C"},{text:"\u9009\u9879\u4E09"}];var F=()=>{const u=r=>a.info(r.text);return t(m,{children:[e(o,{placement:"bottom-start",actions:p,onSelect:u,reference:e(c,{type:"primary",children:"\u6D45\u8272\u98CE\u683C"})}),e(o,{actions:p,theme:"dark",onSelect:u,reference:e(c,{type:"primary",children:"\u6DF1\u8272\u98CE\u683C"})})]})};const k={code:`import React from 'react';
...
};`}},key:"popover-demo",meta:{title:"\u57FA\u7840\u7528\u6CD5"}},S=[{text:"\u9009\u9879\u4E00"},{text:"\u9009\u9879\u4E8C"}],s=["top","top-start","top-end","left","left-start","left-end","right","right-start","right-end","bottom","bottom-start","bottom-end"];var v=()=>{const u=i.exports.useRef(null),[r,n]=i.exports.useState(!1),[d,f]=i.exports.useState(s[0]);return t(E,{children:[e(A,{title:"\u9009\u62E9\u5F39\u51FA\u4F4D\u7F6E",onClick:()=>n(!0),isLink:!0}),t(D,{round:!0,position:"bottom",visible:r,onClose:()=>n(!1),children:[e("div",{style:{display:"flex",justifyContent:"center",margin:"110px 0"},children:e(o,{ref:u,theme:"dark",actions:S,onSelect:l=>a.info(l.text),placement:d,reference:e("div",{style:{width:60,height:60,backgroundColor:"#3f45ff",borderRadius:8}})})}),e(x,{showToolbar:!1,columns:s,onChange:l=>{f(l),setTimeout(()=>u.current.show(),0)}})]})]})};const M={code:`import React, { useRef, useState } from 'react';
...
};`,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useRef, useState } from 'react';
import { Toast, Popover, Popup, Picker, Cell } from 'react-vant-nova';
import type { PopoverInstance, PopoverPlacement } from 'react-vant-nova';
...
};`}},key:"popover-demo-1",meta:{title:"\u5F39\u51FA\u4F4D\u7F6E",compact:!0}},R=[{text:"\u9009\u9879\u4E00",icon:e(P,{})},{text:"\u9009\u9879\u4E8C",icon:e(b,{})},{text:"\u9009\u9879\u4E09",icon:e(y,{})}],O=[{text:"\u9009\u9879\u4E00",disabled:!0},{text:"\u9009\u9879\u4E8C",disabled:!0},{text:"\u9009\u9879\u4E09"}];var C=()=>{const u=r=>a.info(r.text);return t(m,{children:[e(o,{placement:"bottom-start",actions:R,onSelect:u,reference:e(c,{type:"primary",children:"\u5C55\u793A\u56FE\u6807"})}),e(o,{actions:O,onSelect:u,reference:e(c,{type:"primary",children:"\u7981\u7528\u9009\u9879"})})]})};const w=`import React from 'react'
...
`,T={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { AddO, MoreO, MusicO } from '@react-vant/icons'
import { Space, Toast, Button, Popover } from 'react-vant-nova'
...
`}},key:"popover-config",meta:{title:"\u9009\u9879\u914D\u7F6E"}};var B=()=>{const u=i.exports.useRef(null);return e(E,{children:e(o,{ref:u,placement:"top-start",reference:e(c,{type:"primary",children:"\u81EA\u5B9A\u4E49\u5185\u5BB9"}),children:e(h,{square:!0,border:!1,columnNum:3,style:{width:240},children:Array.from({length:6},(r,n)=>e(h.Item,{onClick:()=>{var d;return(d=u.current)==null?void 0:d.hide()},icon:e(g,{}),text:"\u6587\u5B57"},n))})})})};const N=`import React, { useRef } from 'react'
...
`,I={code:N,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react'
import { PhotoO } from '@react-vant/icons'
import { Popover, Button, Grid } from 'react-vant-nova'
import type { PopoverInstance } from 'react-vant-nova'
...
`}},key:"popover-custom",meta:{title:"\u81EA\u5B9A\u4E49\u5185\u5BB9"}},_=function({previewer:u=()=>null,api:r=()=>null}){const n=u;return e("div",{children:t("div",{children:[e("h1",{id:"popover-\u6C14\u6CE1\u5F39\u51FA\u6846","data-anchor":"popover-\u6C14\u6CE1\u5F39\u51FA\u6846",children:"Popover \u6C14\u6CE1\u5F39\u51FA\u6846"}),e("h2",{id:"\u4ECB\u7ECD","data-anchor":"\u4ECB\u7ECD",children:"\u4ECB\u7ECD"}),e("p",{children:"\u5F39\u51FA\u5F0F\u7684\u6C14\u6CE1\u83DC\u5355\u3002"}),e("h2",{id:"\u5F15\u5165","data-anchor":"\u5F15\u5165",children:"\u5F15\u5165"}),e(n,{code:"import { Popover } from 'react-vant-nova';",lang:"js"}),e("h2",{id:"\u4EE3\u7801\u6F14\u793A","data-anchor":"\u4EE3\u7801\u6F14\u793A",children:"\u4EE3\u7801\u6F14\u793A"}),e("h3",{id:"\u57FA\u7840\u7528\u6CD5","data-anchor":"\u57FA\u7840\u7528\u6CD5",children:"\u57FA\u7840\u7528\u6CD5"}),t("p",{children:["\u5F53 Popover \u5F39\u51FA\u65F6\uFF0C\u4F1A\u57FA\u4E8E ",e("code",{children:"reference"})," \u5C5E\u6027\u7684\u5185\u5BB9\u8FDB\u884C\u5B9A\u4F4D\u3002"]}),e(n,{...k,children:e(F,{})}),e("h3",{id:"\u5F39\u51FA\u4F4D\u7F6E","data-anchor":"\u5F39\u51FA\u4F4D\u7F6E",children:"\u5F39\u51FA\u4F4D\u7F6E"}),t("p",{children:["\u901A\u8FC7 ",e("code",{children:"placement"})," \u5C5E\u6027\u6765\u63A7\u5236\u6C14\u6CE1\u7684\u5F39\u51FA\u4F4D\u7F6E\u3002"]}),e(n,{...M,children:e(v,{})}),t("p",{children:[e("code",{children:"placement"})," \u652F\u6301\u4EE5\u4E0B\u503C\uFF1A"]}),e(n,{code:`top           # \u9876\u90E8\u4E2D\u95F4\u4F4D\u7F6E
top-start     # \u9876\u90E8\u5DE6\u4FA7\u4F4D\u7F6E
top-end       # \u9876\u90E8\u53F3\u4FA7\u4F4D\u7F6E
left          # \u5DE6\u4FA7\u4E2D\u95F4\u4F4D\u7F6E
left-start    # \u5DE6\u4FA7\u4E0A\u65B9\u4F4D\u7F6E
