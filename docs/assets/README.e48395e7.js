import{r as c,a as u,F as d,j as e}from"./main.6d1ac2ec.js";import{C as o,dS as l}from"./FloatingPanel.f57aae97.js";const F=[{name:"\u5FAE\u4FE1",icon:"wechat"},{name:"\u5FAE\u535A",icon:"weibo"},{name:"\u590D\u5236\u94FE\u63A5",icon:"link"},{name:"\u5206\u4EAB\u6D77\u62A5",icon:"poster"},{name:"\u4E8C\u7EF4\u7801",icon:"qrcode"}];var h=()=>{const[t,n]=c.exports.useState(!1);return u(d,{children:[e(o,{isLink:!0,title:"\u663E\u793A\u5206\u4EAB\u9762\u677F",onClick:()=>n(!0)}),e(l,{visible:t,options:F,title:"\u7ACB\u5373\u5206\u4EAB\u7ED9\u597D\u53CB",onCancel:()=>n(!1),onSelect:(i,r)=>{console.log("option",i),console.log("index",r),n(!1)}})]})};const p=`import React, { useState } from 'react'
