import{a as e,F as o,j as u}from"./main.af98c409.js";import{C as i,dJ as d,dc as c,i as E}from"./FloatingPanel.788cd8cb.js";import{h}from"./index.52188875.js";var a=()=>{const[t,n]=h.useSetState({v1:!1,v2:!1,v3:!1,v4:!1,v5:!1,v6:!1}),r=F=>c.info(`\u8F93\u5165${F}`),l=()=>c.info("\u5220\u9664");return e(o,{children:[u(i,{title:"\u5F39\u51FA\u9ED8\u8BA4\u952E\u76D8",isLink:!0,onClick:()=>n({v1:!0})}),u(i,{title:"\u5F39\u51FA\u5E26\u53F3\u4FA7\u680F\u7684\u952E\u76D8",isLink:!0,onClick:()=>n({v2:!0})}),u(i,{title:"\u5F39\u51FA\u8EAB\u4EFD\u8BC1\u53F7\u952E\u76D8",isLink:!0,onClick:()=>n({v3:!0})}),u(i,{title:"\u5F39\u51FA\u5E26\u6807\u9898\u7684\u952E\u76D8",isLink:!0,onClick:()=>n({v4:!0})}),u(i,{title:"\u5F39\u51FA\u914D\u7F6E\u591A\u4E2A\u6309\u952E\u7684\u952E\u76D8",isLink:!0,onClick:()=>n({v5:!0})}),u(i,{title:"\u5F39\u51FA\u914D\u7F6E\u968F\u673A\u6570\u5B57\u7684\u952E\u76D8",isLink:!0,onClick:()=>n({v6:!0})}),u(d,{visible:t.v1,onBlur:()=>n({v1:!1}),onInput:r,onDelete:l}),u(d,{theme:"custom",extraKey:".",closeButtonText:"\u5B8C\u6210",visible:t.v2,onBlur:()=>n({v2:!1}),onInput:r,onDelete:l}),u(d,{extraKey:"X",closeButtonText:"\u5B8C\u6210",visible:t.v3,onBlur:()=>n({v3:!1}),onInput:r,onDelete:l}),u(d,{title:"\u952E\u76D8\u6807\u9898",extraKey:".",closeButtonText:"\u5B8C\u6210",visible:t.v4,onBlur:()=>n({v4:!1}),onInput:r,onDelete:l}),u(d,{theme:"custom",extraKey:["00","."],closeButtonText:"\u5B8C\u6210",visible:t.v5,onBlur:()=>n({v5:!1}),onInput:r,onDelete:l}),u(d,{randomKeyOrder:!0,visible:t.v6,onBlur:()=>n({v6:!1}),onInput:r,onDelete:l})]})};const v=`import React from 'react'
...
`,B={code:v,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { NumberKeyboard, Cell, hooks, Toast } from 'react-vant-nova'
...
`}},key:"number-keyboard-base",meta:{title:"\u57FA\u7840\u7528\u6CD5",card:!0}};var s=()=>{const[t,n]=h.useSetState({visible:!1,value:""});return e(o,{children:[u(E,{label:"\u53CC\u5411\u7ED1\u5B9A",value:t.value,readOnly:!0,onClick:()=>n({visible:!0})}),u(d,{value:t.value,visible:t.visible,maxlength:6,onChange:r=>n({value:r}),onBlur:()=>n({visible:!1})})]})};const D=`import React from 'react'
import { Field, NumberKeyboard, hooks } from 'react-vant-nova'
...
`,C={code:D,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Field, NumberKeyboard, hooks } from 'react-vant-nova'
