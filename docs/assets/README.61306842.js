import{r,a as e,F as E,j as n}from"./main.929296ee.js";import{ek as C,dg as m,el as v,dd as g}from"./TreeSelect.6eee9680.js";const t={id:1,condition:`\u65E0\u4F7F\u7528\u95E8\u69DB
\u6700\u591A\u4F18\u60E012\u5143`,reason:"",value:150,name:"\u4F18\u60E0\u5238\u540D\u79F0",description:"\u63CF\u8FF0\u4FE1\u606F",startAt:1489104e3,endAt:1514592e3,valueDesc:"1.5",unitDesc:"\u5143"},D={...t,id:2,value:12,valueDesc:"8.8",unitDesc:"\u6298"},b={...t,id:3,reason:"\u4F18\u60E0\u5238\u4E0D\u53EF\u7528\u539F\u56E0"},h={...D,valueDesc:"1",unitDesc:"\u6298",id:4,reason:"\u4F18\u60E0\u5238\u4E0D\u53EF\u7528\u539F\u56E0"},x=(d=999999)=>String(Math.floor(Math.random()*d)+1);var s=()=>{const[d,o]=r.exports.useState([t,h]),[u]=r.exports.useState([b,h]),[l,a]=r.exports.useState(-1),[p,i]=r.exports.useState(!1);return e(E,{children:[n(C,{coupons:d,chosenCoupon:l,onClick:()=>i(!0)}),n(m,{round:!0,position:"bottom",style:{height:"90%",paddingTop:4},visible:p,onClose:()=>i(!1),children:n(v,{chosenCoupon:l,coupons:d,disabledCoupons:u,onChange:c=>{i(!1),a(c)},onExchange:c=>{console.log("code: ",c),g("\u5151\u6362\u6210\u529F"),o(F=>[...F,{...t,id:x()}])}})})]})};const A=`import React, { useState } from 'react'
...
`,B={code:A,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { CouponList, Popup, Toast, CouponCell } from 'react-vant-nova'
import { data, disabledDiscountCoupon, disabledCoupon } from './demo'
