import{a as r,j as e,F as l}from"./main.1e1a3839.js";import{C as u,I as E,f as s,g as B,h as g}from"./TreeSelect.913ffb06.js";var i=()=>r(u.Group,{children:[e(u,{title:"\u5355\u5143\u683C",value:"\u5185\u5BB9"}),e(u,{title:"\u5355\u5143\u683C",value:"\u5185\u5BB9",label:"\u63CF\u8FF0\u4FE1\u606F"})]});const A=`import React from 'react'
...
`,x={code:D,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell, Image } from 'react-vant-nova'
...
`,_={code:y,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell } from 'react-vant-nova'
...
`}},key:"cell-size",meta:{title:"\u5355\u5143\u683C\u5927\u5C0F"}};var h=()=>r(l,{children:[e(u,{title:"\u5355\u5143\u683C",icon:e(s,{})}),e(u,{title:"\u5355\u5143\u683C",icon:e(B,{})})]});const b=`import { FireO, LocationO } from '@react-vant/icons'
...
`,P={code:b,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.1.0"},react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import { FireO, LocationO } from '@react-vant/icons'
import React from 'react'
import { Cell } from 'react-vant-nova'
...
`}},key:"cell-icon",meta:{title:"\u5C55\u793A\u56FE\u6807"}};var o=()=>e(u,{value:"\u5185\u5BB9"});const M=`import React from 'react'
import { Cell } from 'react-vant-nova'

export default () => {
  return <Cell value='\u5185\u5BB9' />
}
`,k={code:M,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell } from 'react-vant-nova'
...
`,w={code:R,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell } from 'react-vant-nova'
...
`,N={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell } from 'react-vant-nova'
...
`,z={code:G,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell } from 'react-vant-nova'
...
`,I={code:$,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.1.0"},react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import { ShopO } from '@react-vant/icons'
import React from 'react'
import { Cell } from 'react-vant-nova'
