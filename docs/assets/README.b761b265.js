import{a as e,j as n}from"./main.7a53fb72.js";import{e4 as t,H as o,I as v}from"./FloatingPanel.c7f80ee3.js";const F=["#ace0ff","#bcffbd","#e4fabd","#ffcfac"],d=F.map((r,u)=>e(t.Item,{children:e("div",{onClick:()=>{o.info(`\u4F60\u70B9\u51FB\u4E86\u5361\u7247 ${u+1}`)},children:u+1})},r));var c=()=>e("div",{className:"demo-swiper",children:e(t,{autoplay:5e3,children:d})});const E={code:`import React from 'react';
