import{j as e,a as n}from"./main.9eb8bb9a.js";import{e3 as t,dc as o,I as v}from"./FloatingPanel.9e7a63ee.js";const F=["#ace0ff","#bcffbd","#e4fabd","#ffcfac"],d=F.map((r,u)=>e(t.Item,{children:e("div",{onClick:()=>{o.info(`\u4F60\u70B9\u51FB\u4E86\u5361\u7247 ${u+1}`)},children:u+1})},r));var c=()=>e("div",{className:"demo-swiper",children:e(t,{autoplay:5e3,children:d})});const E={code:`import React from 'react';
