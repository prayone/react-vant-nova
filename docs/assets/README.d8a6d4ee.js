import{r as a,j as e,a as n}from"./main.929296ee.js";import{k as l,dd as i}from"./TreeSelect.6eee9680.js";var c=()=>{const[t,r]=a.exports.useState(10);return e(l,{value:t,onChange:r,onChangeAfter:d=>i.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const f={code:`import { useState } from 'react';
...
};`,lang:"jsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.jsx":{type:"FILE",value:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant-nova';
...
export default () => {
  ...
  return <Slider value={value} onChange={setValue} onChangeAfter={onChangeAfter} />;
};`}},key:"slider-demo",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var h=()=>{const[t,r]=a.exports.useState([10,50]);return e(l,{range:!0,value:t,onChange:r,onChangeAfter:d=>i.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const E={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant-nova';
...
export default () => {
  ...
  return <Slider range value={value} onChange={setValue} onChangeAfter={onChangeAfter} />;
};`}},key:"slider-demo-1",meta:{title:"\u53CC\u6ED1\u5757"}};var s=()=>{const[t,r]=a.exports.useState(10);return e(l,{min:-50,max:50,value:t,onChange:r,onChangeAfter:d=>i.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const g={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant-nova';
...
};`}},key:"slider-demo-5",meta:{title:"\u81EA\u5B9A\u4E49\u6837\u5F0F"}};var A=()=>{const[t,r]=a.exports.useState(10);return e(l,{button:e("div",{className:"custom-slider-button",children:t}),value:t,onChange:r,onChangeAfter:d=>i.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const B={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant-nova';
...
`}},key:"slider-demo-6",meta:{title:"\u81EA\u5B9A\u4E49\u6309\u94AE"}};var m=()=>{const[t,r]=a.exports.useState(50),[u,d]=a.exports.useState([20,50]),o=p=>i.info(`\u5F53\u524D\u503C\uFF1A${p}`);return n("div",{style:{height:150,paddingLeft:30},children:[e(l,{vertical:!0,style:{marginRight:100},value:t,onChange:r,onChangeAfter:o}),e(l,{range:!0,vertical:!0,value:u,onChange:d,onChangeAfter:o})]})};const y={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant-nova';
...
};`,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant-nova';
