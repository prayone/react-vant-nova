...
`}},key:"number-keyboard-base",meta:{title:"\u57FA\u7840\u7528\u6CD5",card:!0}};var E=()=>{const[t,n]=h.useSetState({visible:!1,value:""});return e(o,{children:[u(s,{label:"\u53CC\u5411\u7ED1\u5B9A",value:t.value,readOnly:!0,onClick:()=>n({visible:!0})}),u(d,{value:t.value,visible:t.visible,maxlength:6,onChange:r=>n({value:r}),onBlur:()=>n({visible:!1})})]})};const C=`import React from 'react'
...
`,D={code:C,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Field, NumberKeyboard, hooks } from 'react-vant-nova'
