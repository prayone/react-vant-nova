import{j as n,a as e}from"./main.af98c409.js";import{e9 as c,da as a,db as u,e as h,cD as l,a5 as o,aG as F,D as E,ea as p}from"./FloatingPanel.788cd8cb.js";var d=()=>n("div",{children:e(c,{anchors:[170,320,window.innerHeight*.8],children:[n(a,{}),e(u,{gutter:8,children:[n(u.Item,{icon:n(h,{}),onClick:()=>0,text:"\u9644\u8FD1"}),n(u.Item,{icon:n(l,{}),onClick:()=>0,text:"\u6536\u85CF"}),n(u.Item,{icon:n(o,{}),onClick:()=>0,text:"\u8D2D\u7269\u8F66"}),n(u.Item,{icon:n(F,{}),onClick:()=>0,text:"\u4F18\u60E0"})]}),n(E,{children:"\u597D\u7269\u63A8\u8350"}),Array.from(Array(5)).map((t,i)=>n(p,{title:"\u70ED\u5356\u5546\u54C1"+i,thumb:"https://img.yzcdn.cn/vant/ipad.jpeg",desc:"\u70ED\u5356\u5546\u54C1\uFF0C\u4F18\u60E0\u540E 2.00",num:3,price:"2.00"},i))]})});const C=`import React from 'react'
import {
  ProductCard,
  Grid,
  FloatingPanel,
...
`,D={code:C,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import {
  ProductCard,
  Grid,
  FloatingPanel,
