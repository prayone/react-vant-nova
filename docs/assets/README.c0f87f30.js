...
`,E={code:C,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { ConfigProvider, Calendar } from 'react-vant-nova'
import locale from './enUs'
import './style.less'
...
`,m={code:g,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { ConfigProvider, Button, Rate, Field, Slider } from 'react-vant-nova'
import './style.less'
