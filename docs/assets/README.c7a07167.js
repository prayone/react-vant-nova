import{j as e,a as n,F as c,r as s}from"./main.6d1ac2ec.js";import{dX as r,dc as m,db as d,c2 as F,bR as p,c as C}from"./FloatingPanel.f57aae97.js";var i=()=>e(r,{time:30*60*60*1e3});const E={code:`import React from 'react';
...
`,A={code:v,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react'
import { CountDown, Grid, Toast } from 'react-vant-nova'
import { PauseCircleO, PlayCircleO, Replay } from '@react-vant/icons'
import type { CountDownInstance } from 'react-vant-nova'
