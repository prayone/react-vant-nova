import{r as c,j as u,a as e}from"./main.929296ee.js";import{dR as r,dS as i,dd as o}from"./TreeSelect.6eee9680.js";var s=()=>{const[t,h]=c.exports.useState(0),n=c.exports.useMemo(()=>t?`\u5237\u65B0\u6B21\u6570: ${t}`:"\u4E0B\u62C9\u8BD5\u8BD5",[t]),d=l=>new Promise(a=>{setTimeout(()=>{l&&o.info("\u5237\u65B0\u6210\u529F"),h(t+1),a(!0)},1e3)});return u("div",{className:"demo-pull-refresh",children:e(r,{children:[u(r.TabPane,{title:"\u57FA\u7840\u7528\u6CD5",children:u(i,{onRefresh:()=>d(!0),onRefreshEnd:()=>console.log("onRefreshEnd"),children:u("p",{children:n})})}),u(r.TabPane,{title:"\u6210\u529F\u63D0\u793A",children:u(i,{successText:"\u5237\u65B0\u6210\u529F",onRefresh:()=>d(!1),children:u("p",{children:n})})}),u(r.TabPane,{title:"\u81EA\u5B9A\u4E49\u5185\u5BB9",children:u(i,{headHeight:80,pullingText:({distance:l})=>u("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge.png",style:{transform:`scale(${l/80})`}}),loosingText:()=>u("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge.png"}),loadingText:()=>u("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge-fire.jpg"}),onRefresh:()=>d(!0),children:u("p",{children:n})})})]})})};const E=`import React, { useState, useMemo } from 'react'
...
`,p={code:E,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useState, useMemo } from 'react'
import { PullRefresh, Tabs, Toast } from 'react-vant-nova'
import './style.less'
...
`}},key:"pull-refresh-demo",meta:{}},F=function({previewer:t=()=>null,api:h=()=>null}){const n=t;return u("div",{children:e("div",{children:[u("h1",{id:"pullrefresh-\u4E0B\u62C9\u5237\u65B0","data-anchor":"pullrefresh-\u4E0B\u62C9\u5237\u65B0",children:"PullRefresh \u4E0B\u62C9\u5237\u65B0"}),u("h2",{id:"\u4ECB\u7ECD","data-anchor":"\u4ECB\u7ECD",children:"\u4ECB\u7ECD"}),u("p",{children:"\u7528\u4E8E\u63D0\u4F9B\u4E0B\u62C9\u5237\u65B0\u7684\u4EA4\u4E92\u64CD\u4F5C\u3002"}),u("h2",{id:"\u5F15\u5165","data-anchor":"\u5F15\u5165",children:"\u5F15\u5165"}),u(n,{code:"import { PullRefresh } from 'react-vant-nova';",lang:"js"}),u("h2",{id:"\u4EE3\u7801\u6F14\u793A","data-anchor":"\u4EE3\u7801\u6F14\u793A",children:"\u4EE3\u7801\u6F14\u793A"}),u("h3",{id:"\u57FA\u7840\u7528\u6CD5","data-anchor":"\u57FA\u7840\u7528\u6CD5",children:"\u57FA\u7840\u7528\u6CD5"}),e("p",{children:["\u4E0B\u62C9\u5237\u65B0\u65F6\u4F1A\u89E6\u53D1 ",u("code",{children:"onRefresh"})," \u4E8B\u4EF6\uFF0C\u5728\u4E8B\u4EF6\u7684\u56DE\u8C03\u51FD\u6570\u4E2D\u53EF\u4EE5\u8FDB\u884C\u540C\u6B65\u6216\u5F02\u6B65\u64CD\u4F5C\uFF0C\u64CD\u4F5C\u5B8C\u6210\u540E\u8868\u793A\u52A0\u8F7D\u5B8C\u6210\u3002"]}),u("blockquote",{children:u("p",{children:"\u548C vant \u4E0D\u540C\u7684\u662F\uFF0Creact-vant \u6839\u636E onRefresh \u5728\u7EC4\u4EF6\u5185\u90E8\u7EF4\u62A4\u4E86 loading \u72B6\u6001\u3002"})}),u(n,{...p,children:u(s,{})}),u("h3",{id:"\u6210\u529F\u63D0\u793A","data-anchor":"\u6210\u529F\u63D0\u793A",children:"\u6210\u529F\u63D0\u793A"}),e("p",{children:["\u901A\u8FC7 ",u("code",{children:"successText"})," \u53EF\u4EE5\u8BBE\u7F6E\u5237\u65B0\u6210\u529F\u540E\u7684\u9876\u90E8\u63D0\u793A\u6587\u6848\u3002"]}),u(n,{code:`<PullRefresh successText="\u5237\u65B0\u6210\u529F" onRefresh="{onRefresh}">
  <p>\u4E0B\u62C9\u5237\u65B0</p>
