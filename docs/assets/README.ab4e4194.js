...
`,g={code:v,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.9"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell, Input, hooks } from 'react-vant-nova'
...
};`}},key:"input-demo-3",meta:{title:"\u5B57\u6570\u7EDF\u8BA1"}};var C=()=>{const[n,d]=a.exports.useState("");return u(i,{children:[e(r,{children:e(l,{placeholder:"\u5185\u5BB9\u5267\u4E2D",value:n,onChange:d,align:"center"})}),e(r,{children:e(l,{placeholder:"\u5185\u5BB9\u53F3\u5BF9\u9F50",value:n,onChange:d,align:"right"})})]})};const I={code:`import React, { useState } from 'react';
import { Input, Cell } from 'react-vant-nova';
...
};`}},key:"input-demo-4",meta:{title:"\u5BF9\u9F50\u65B9\u5F0F"}};var s=()=>{const[n,d]=a.exports.useState("\u53EA\u8BFB\u6A21\u5F0F"),[t,E]=a.exports.useState("\u7981\u7528\u6A21\u5F0F");return u(i,{children:[e(r,{children:e(l,{value:n,onChange:d,readOnly:!0})}),e(r,{children:e(l,{value:t,onChange:E,disabled:!0})})]})};const S={code:`import React, { useState } from 'react';
import { Input, Cell } from 'react-vant-nova';
