import{j as u,r as d,F as o,a as e}from"./main.929296ee.js";import{j as l,C as E,h,d4 as y,dd as F,F as S,w as P,B as p,dg as M,dq as R}from"./TreeSelect.6eee9680.js";var C=()=>u(l,{label:"\u6587\u672C",tooltip:"\u63D0\u793Atooltip",intro:u("div",{children:"We must make sure that your are a human."}),placeholder:"\u8BF7\u8F93\u5165\u6587\u672C"});const k={code:`import React, { useState } from 'react';
...
};`}},key:"field-demo",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var m=()=>{const[n,r]=d.exports.useState(""),[t,i]=d.exports.useState("");return u(o,{children:e(E.Group,{children:[u(l,{value:n,onChange:r,label:"\u6587\u672C",leftIcon:u(h,{}),rightIcon:u(y,{}),placeholder:"\u663E\u793A\u56FE\u6807",onClickLeftIcon:()=>F.info("\u5DE6\u4FA7\u56FE\u6807\u70B9\u51FB"),onClickRightIcon:()=>F.info("\u53F3\u4FA7\u56FE\u6807\u70B9\u51FB")}),u(l,{value:t,onChange:i,clearable:!0,label:"\u6587\u672C",leftIcon:u(h,{}),placeholder:"\u663E\u793A\u6E05\u9664\u56FE\u6807"})]})})};const w=`import { ShopO, WarningO } from '@react-vant/icons'
...
`,I={code:w,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.1.0"},react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import { ShopO, WarningO } from '@react-vant/icons'
import React, { useState } from 'react'
import { Cell, Field, Toast } from 'react-vant-nova'
...
`}},key:"field-icon",meta:{title:"\u663E\u793A\u56FE\u6807"}};var B=()=>{const[n,r]=d.exports.useState(""),[t,i]=d.exports.useState("");return u(o,{children:e(E.Group,{children:[u(l,{value:n,error:!0,required:!0,label:"\u7528\u6237\u540D",placeholder:"\u8BF7\u8F93\u5165\u7528\u6237\u540D",onChange:r}),u(l,{value:t,required:!0,label:"\u624B\u673A\u53F7",placeholder:"\u8BF7\u8F93\u5165\u624B\u673A\u53F7",errorMessage:"\u624B\u673A\u53F7\u683C\u5F0F\u9519\u8BEF",onChange:i})]})})};const V=`import React, { useState } from 'react'
...
`,L={code:V,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Cell, Field } from 'react-vant-nova'
...
`}},key:"field-error",meta:{title:"\u9519\u8BEF\u63D0\u793A"}},s=["86 \u{1F1E8}\u{1F1F3}","87 \u{1F1FA}\u{1F1F8}","88 \u{1F3F3}\uFE0F\u200D\u{1F308}","89 \u{1F3F3}\uFE0F\u200D\u26A7\uFE0F","90 \u{1F1F4}\u{1F1F2}","91 \u{1F1F5}\u{1F1EA}","92 \u{1F1E9}\u{1F1EA}"];var v=()=>{const[n,r]=d.exports.useState(""),[t,i]=d.exports.useState(!1),[c,a]=d.exports.useState(s[0]);return e(o,{children:[u(l,{value:n,center:!0,label:"\u77ED\u4FE1\u9A8C\u8BC1\u7801",placeholder:"\u624B\u673A\u53F7",onChange:r,prefix:e(S,{align:"center",onClick:()=>i(!0),children:["+",c," ",u(P,{style:{paddingLeft:8}})]}),suffix:u(p,{size:"small",type:"primary",children:"\u53D1\u9001"})}),u(M,{round:!0,visible:t,position:"bottom",onClose:()=>i(!1),children:u(R,{title:"\u6807\u9898",onConfirm:b=>{a(b),i(!1)},columns:s})})]})};const _=`import React, { useState } from 'react'
...
`,N={code:_,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Field, Flex, Popup, Picker, Button } from 'react-vant-nova'
import { ArrowDown } from '@react-vant/icons'
...
`}},key:"field-button",meta:{title:"\u63D2\u5165\u6309\u94AE"}};var A=()=>{const[n,r]=d.exports.useState(""),[t,i]=d.exports.useState(""),c=a=>a.replace(/\d/g,"");return e(o,{children:[u(l,{value:n,label:"\u6587\u672C",formatter:c,placeholder:"\u5728\u8F93\u5165\u65F6\u6267\u884C\u683C\u5F0F\u5316",onChange:r}),u(l,{value:t,label:"\u6587\u672C",formatter:c,formatTrigger:"onBlur",placeholder:"\u5728\u5931\u7126\u65F6\u6267\u884C\u683C\u5F0F\u5316",onChange:i})]})};const T=`import React, { useState } from 'react'
import { Field } from 'react-vant-nova'
...
`,z={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Field } from 'react-vant-nova'
...
`}},key:"field-formatter",meta:{title:"\u683C\u5F0F\u5316\u8F93\u5165\u5185\u5BB9"}};var f=()=>{const[n,r]=d.exports.useState("");return u(l,{rows:1,value:n,onChange:r,label:"\u7559\u8A00",type:"textarea",placeholder:"\u8BF7\u8F93\u5165\u7559\u8A00"})};const O={code:`import React, { useState } from 'react';
import { Field } from 'react-vant-nova';
...
};`}},key:"field-demo-1",meta:{title:"\u9AD8\u5EA6\u81EA\u9002\u5E94"}};var D=()=>{const[n,r]=d.exports.useState("");return u(l,{rows:2,autoSize:!0,label:"\u7559\u8A00",type:"textarea",placeholder:"\u8BF7\u8F93\u5165\u7559\u8A00",value:n,onChange:r,maxLength:50,showWordLimit:!0})};const W={code:`import React, { useState } from 'react';
import { Field } from 'react-vant-nova';
...
};`}},key:"field-demo-2",meta:{title:"\u663E\u793A\u5B57\u6570\u7EDF\u8BA1"}};var g=()=>u(l,{label:"\u6587\u672C",placeholder:"\u8F93\u5165\u6846\u5185\u5BB9\u53F3\u5BF9\u9F50",align:"right"});const j={code:`import React from 'react';
import { Field } from 'react-vant-nova';
...
export default () => {
  return <Field label="\u6587\u672C" placeholder="\u8F93\u5165\u6846\u5185\u5BB9\u53F3\u5BF9\u9F50" align="right" />;
};`}},key:"field-demo-3",meta:{title:"\u8F93\u5165\u6846\u5185\u5BB9\u5BF9\u9F50"}};var x=()=>{const n=d.exports.useRef(null);return u(l,{center:!0,ref:n,placeholder:"\u8BF7\u8F93\u5165\u6587\u672C",label:"\u6587\u672C",suffix:u(p,{size:"small",onClick:()=>{var r;(r=n==null?void 0:n.current)==null||r.focus()},children:"\u805A\u7126"})})};const G=`import React, { useRef } from 'react'
...
`,$={code:G,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react'
import { Field, Button } from 'react-vant-nova'
import type { FieldInstance } from 'react-vant-nova'
