import{j as u,a as e,R as o}from"./main.929296ee.js";import{dr as d,dd as B,aW as g,dM as D,dj as i,B as y}from"./TreeSelect.6eee9680.js";const b=[{url:"https://img.yzcdn.cn/vant/sand.jpg"},{url:"https://img.yzcdn.cn/vant/sand.text"}];var F=()=>u(d,{accept:"*",defaultValue:b,onChange:n=>console.log(n)});const x=`import React from 'react'
...
`,U={code:x,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Uploader } from 'react-vant-nova'
import './style.less'
...
`}},key:"uploader-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}},I="https://nextjs-upload-service.vercel.app/api/upload",l=async n=>{try{const t=new FormData;return t.append("source",n),(await(await fetch(I,{method:"POST",body:t})).json()).image}catch{return{url:`demo_path/${n.name}`}}},a=[{url:"https://img.yzcdn.cn/vant/sand.jpg",filename:"\u56FE\u7247\u540D\u79F0"},{url:"https://img.yzcdn.cn/vant/tree.jpg",filename:"\u56FE\u7247\u540D\u79F0"}];var E=()=>u(d,{defaultValue:a,upload:l});const _=`import React from 'react'
import { Uploader } from 'react-vant-nova'
...
`,k={code:_,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Uploader } from 'react-vant-nova'
import { upload, demoData } from './utils'
import './style.less'
...
`}},key:"uploader-upload",meta:{title:"\u81EA\u52A8\u4E0A\u4F20"}};var m=()=>u(d,{multiple:!0,upload:l,defaultValue:[a[0]],maxCount:2,maxSize:15*1024,onOversize:()=>B.info("\u6587\u4EF6\u5927\u5C0F\u4E0D\u80FD\u8D85\u8FC715kb")});const P=`import React from 'react'
...
`,w={code:P,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Toast, Uploader } from 'react-vant-nova'
import { demoData, upload } from './utils'
import './style.less'
...
`}},key:"uploader-limit",meta:{title:"\u4E0A\u4F20\u9650\u5236"}};var v=()=>u(d,{defaultValue:a,upload:l,previewSize:60,uploadIcon:u(g,{}),previewCoverRender:n=>n.filename&&u("div",{style:{position:"absolute",bottom:0,width:" 100%",color:"#fff",fontSize:12,textAlign:"center",background:"#00000030"},children:n.filename})});const R=`import React from 'react'
import { Uploader } from 'react-vant-nova'
import { upload, demoData } from './utils'
...
`,j={code:R,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Uploader } from 'react-vant-nova'
import { upload, demoData } from './utils'
import { Fire } from '@react-vant/icons'
import './style.less'
...
`}},key:"uploader-preview",meta:{title:"\u81EA\u5B9A\u4E49\u9884\u89C8"}};var C=()=>u(d,{defaultValue:a,upload:l,onDelete:()=>D.confirm({title:"\u63D0\u793A",message:"\u786E\u8BA4\u5220\u9664?\u{1F914}"})});const z=`import React from 'react'
...
`,M={code:z,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Uploader, Dialog } from 'react-vant-nova'
import { upload, demoData } from './utils'
import './style.less'
...
`}},key:"uploader-close",meta:{title:"\u5F02\u6B65\u5173\u95ED"}},V=n=>{const[t,r]=o.useState([]),c=o.useRef(0);return o.useEffect(()=>{n.value!==void 0&&(!t[0]||n.value!==t[0].url)&&r([{url:n.value,id:c.current++}])},[n.value]),u(d,{value:t,upload:l,maxCount:1,onChange:h=>{var s,p;r(h);const A=(s=h[0])==null?void 0:s.url;(p=n.onChange)==null||p.call(n,A)}})};var f=()=>{const[n]=i.useForm();return e(i,{colon:!0,form:n,footer:u(y,{style:{marginTop:20},onClick:async()=>{const r=await n.validateFields();console.log(r)},type:"primary",round:!0,block:!0,children:"\u786E\u8BA4"}),children:[u(i.Item,{rules:[{required:!0,message:"\u8BF7\u4E0A\u4F20\u5934\u50CF"}],label:"\u4E0A\u4F20\u5934\u50CF",name:"avatar",initialValue:"https://iili.io/NZiS9e.png",children:u(V,{})}),u(i.Item,{rules:[{required:!0,message:"\u8BF7\u4E0A\u4F20\u5934\u50CF"}],label:"\u4E0A\u4F20\u9644\u4EF6",name:"files",children:u(d,{accept:"*"})})]})};const O=`import React from 'react'
...
`,T={code:O,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Form, Uploader, UploaderValueItem, Button } from 'react-vant-nova'
import { upload } from './utils'
import './style.less'
...
};`,lang:"jsx"}),u("h3",{id:"\u4E0A\u4F20-heicheif-\u683C\u5F0F\u7684\u56FE\u7247\u540E\u65E0\u6CD5\u5C55\u793A","data-anchor":"\u4E0A\u4F20-heicheif-\u683C\u5F0F\u7684\u56FE\u7247\u540E\u65E0\u6CD5\u5C55\u793A",children:"\u4E0A\u4F20 HEIC/HEIF \u683C\u5F0F\u7684\u56FE\u7247\u540E\u65E0\u6CD5\u5C55\u793A\uFF1F"}),u("p",{children:"\u76EE\u524D Chrome\u3001Safari \u7B49\u6D4F\u89C8\u5668\u4E0D\u652F\u6301\u5C55\u793A HEIC/HEIF \u683C\u5F0F\u7684\u56FE\u7247\uFF0C\u56E0\u6B64\u4E0A\u4F20\u540E\u65E0\u6CD5\u5728 Uploader \u7EC4\u4EF6\u4E2D\u8FDB\u884C\u9884\u89C8\u3002"}),e("p",{children:["[HEIF] \u683C\u5F0F\u7684\u517C\u5BB9\u6027\u8BF7\u53C2\u8003 ",u("a",{href:"https://caniuse.com/?search=heic",children:"caniuse"}),"\u3002"]})]})})},S=[{Component:F,key:"uploader-base",title:"\u57FA\u7840\u7528\u6CD5"},{Component:E,key:"uploader-upload",title:"\u81EA\u52A8\u4E0A\u4F20"},{Component:m,key:"uploader-limit",title:"\u4E0A\u4F20\u9650\u5236"},{Component:v,key:"uploader-preview",title:"\u81EA\u5B9A\u4E49\u9884\u89C8"},{Component:C,key:"uploader-close",title:"\u5F02\u6B65\u5173\u95ED"},{Component:f,key:"uploader-form",title:"\u8868\u5355\u4E2D\u4F7F\u7528"}],N={simulator:{compact:!1,style:{background:"#fff"}}},$=[{depth:1,text:"Uploader \u6587\u4EF6\u4E0A\u4F20",id:"uploader-\u6587\u4EF6\u4E0A\u4F20"},{depth:2,text:"\u4ECB\u7ECD",id:"\u4ECB\u7ECD"},{depth:2,text:"\u5F15\u5165",id:"\u5F15\u5165"},{depth:2,text:"\u4EE3\u7801\u6F14\u793A",id:"\u4EE3\u7801\u6F14\u793A"},{depth:3,text:"\u57FA\u7840\u7528\u6CD5",id:"\u57FA\u7840\u7528\u6CD5"},{depth:3,text:"\u81EA\u52A8\u4E0A\u4F20",id:"\u81EA\u52A8\u4E0A\u4F20"},{depth:3,text:"\u4E0A\u4F20\u9650\u5236",id:"\u4E0A\u4F20\u9650\u5236"},{depth:3,text:"\u81EA\u5B9A\u4E49\u9884\u89C8",id:"\u81EA\u5B9A\u4E49\u9884\u89C8"},{depth:3,text:"\u5F02\u6B65\u5173\u95ED",id:"\u5F02\u6B65\u5173\u95ED"},{depth:3,text:"\u8868\u5355\u4E2D\u4F7F\u7528",id:"\u8868\u5355\u4E2D\u4F7F\u7528"},{depth:2,text:"API",id:"api"},{depth:3,text:"Props",id:"props"},{depth:3,text:"Events",id:"events"},{depth:3,text:"UploaderValueItem \u7C7B\u578B",id:"uploadervalueitem-\u7C7B\u578B"},{depth:3,text:"ResultType \u53EF\u9009\u503C",id:"resulttype-\u53EF\u9009\u503C"},{depth:3,text:"\u7C7B\u578B\u5B9A\u4E49",id:"\u7C7B\u578B\u5B9A\u4E49"},{depth:2,text:"\u4E3B\u9898\u5B9A\u5236",id:"\u4E3B\u9898\u5B9A\u5236"},{depth:3,text:"\u6837\u5F0F\u53D8\u91CF",id:"\u6837\u5F0F\u53D8\u91CF"},{depth:2,text:"\u5E38\u89C1\u95EE\u9898",id:"\u5E38\u89C1\u95EE\u9898"},{depth:3,text:"\u62CD\u7167\u4E0A\u4F20\u7684\u56FE\u7247\u88AB\u65CB\u8F6C 90 \u5EA6\uFF1F",id:"\u62CD\u7167\u4E0A\u4F20\u7684\u56FE\u7247\u88AB\u65CB\u8F6C-90-\u5EA6"},{depth:4,text:"\u793A\u4F8B",id:"\u793A\u4F8B"},{depth:3,text:"\u4E0A\u4F20 HEIC/HEIF \u683C\u5F0F\u7684\u56FE\u7247\u540E\u65E0\u6CD5\u5C55\u793A\uFF1F",id:"\u4E0A\u4F20-heicheif-\u683C\u5F0F\u7684\u56FE\u7247\u540E\u65E0\u6CD5\u5C55\u793A"}],q="/src/components/uploader/README.md",H="Uploader \u6587\u4EF6\u4E0A\u4F20",W="1766203394000";var K=n=>n.children({MdContent:L,demos:S,frontmatter:N,slugs:$,filePath:q,title:H,updatedTime:W});export{L as MdContent,K as default,S as demos,q as filePath,N as frontmatter,$ as slugs,H as title,W as updatedTime};
