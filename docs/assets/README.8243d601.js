import{r as h,j as e,a as u}from"./main.6f38626e.js";import{dQ as d,dR as c,dc as o}from"./FloatingPanel.cc4d0a22.js";var s=()=>{const[r,l]=h.exports.useState(0),n=h.exports.useMemo(()=>r?`\u5237\u65B0\u6B21\u6570: ${r}`:"\u4E0B\u62C9\u8BD5\u8BD5",[r]),t=i=>new Promise(a=>{setTimeout(()=>{i&&o.info("\u5237\u65B0\u6210\u529F"),l(r+1),a(!0)},1e3)});return e("div",{className:"demo-pull-refresh",children:u(d,{children:[e(d.TabPane,{title:"\u57FA\u7840\u7528\u6CD5",children:e(c,{onRefresh:()=>t(!0),onRefreshEnd:()=>console.log("onRefreshEnd"),children:e("p",{children:n})})}),e(d.TabPane,{title:"\u6210\u529F\u63D0\u793A",children:e(c,{successText:"\u5237\u65B0\u6210\u529F",onRefresh:()=>t(!1),children:e("p",{children:n})})}),e(d.TabPane,{title:"\u81EA\u5B9A\u4E49\u5185\u5BB9",children:e(c,{headHeight:80,pullingText:({distance:i})=>e("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge.png",style:{transform:`scale(${i/80})`}}),loosingText:()=>e("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge.png"}),loadingText:()=>e("img",{className:"doge",src:"https://img.yzcdn.cn/vant/doge-fire.jpg"}),onRefresh:()=>t(!0),children:e("p",{children:n})})})]})})};const E=`import React, { useState, useMemo } from 'react'
