import{j as u,a as e,r as l}from"./main.929296ee.js";import{dR as c,e2 as E,C as h,dS as A}from"./TreeSelect.6eee9680.js";async function D(n){return new Promise((i,t)=>{setTimeout(()=>{n&&t(new Error("error")),i(Array.from({length:10},(a,o)=>o))},2e3)})}const f=()=>{const[n,i]=l.exports.useState([]),[t,a]=l.exports.useState(!1);return u(E,{finished:t,onLoad:async()=>{const F=await D();i(r=>[...r,...F]),n.length>=30&&a(!0)},children:n.map((F,r)=>u(h,{title:r+1},r))})},m=()=>{const[n,i]=l.exports.useState([]),[t,a]=l.exports.useState(!1),[o,F]=l.exports.useState(0);return u(E,{finished:t,errorText:"\u8BF7\u6C42\u5931\u8D25\uFF0C\u70B9\u51FB\u91CD\u65B0\u52A0\u8F7D",onLoad:async()=>{F(s=>s+1);const d=await D(o===1);i(s=>[...s,...d]),n.length>=30&&a(!0)},children:n.map((d,s)=>u(h,{title:s+1},s))})},L=()=>{const[n,i]=l.exports.useState([]),[t,a]=l.exports.useState(!1),o=async r=>{const d=await D();i(s=>{const C=r?d:[...s,...d];return C.length>=30&&a(!0),C})};return u(A,{onRefresh:async()=>{a(!1),await o(1)},children:u(E,{finished:t,onLoad:o,children:n.map((r,d)=>u(h,{title:d+1},d))})})};var B=()=>u("div",{className:"demo-list",children:e(c,{sticky:!0,children:[u(c.TabPane,{title:"\u57FA\u672C\u7528\u6CD5",children:u(f,{})}),u(c.TabPane,{title:"\u9519\u8BEF\u63D0\u793A",children:u(m,{})}),u(c.TabPane,{title:"\u4E0B\u62C9\u5237\u65B0",children:u(L,{})})]})});const p=`/* eslint-disable react/no-array-index-key */
...
`,b={code:p,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`/* eslint-disable react/no-array-index-key */
import React, { useState } from 'react'
import { PullRefresh, List, Tabs, Cell } from 'react-vant-nova'
import './style.less'
