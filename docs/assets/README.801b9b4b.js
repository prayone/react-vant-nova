import{j as u,R as d,F as f,r as g,a as e}from"./main.929296ee.js";import{dq as c,dd as o,j as y}from"./TreeSelect.6eee9680.js";const P=[{text:"\u5357\u4EAC",value:0},{text:"\u82CF\u5DDE",value:1},{text:"\u5E38\u5DDE",value:2},{text:"\u6DEE\u5B89",value:3},{text:"\u626C\u5DDE",value:4},{text:"\u5357\u901A",value:5},{text:"\u5BBF\u8FC1",value:6},{text:"\u6CF0\u5DDE",value:7},{text:"\u65E0\u9521",value:8},{text:"\u957F\u6C99",value:9}];var D=()=>u(c,{title:"\u57FA\u7840\u4F7F\u7528",columns:P,onChange:(n,r,t)=>{console.log("\u9009\u4E2D\u9879: ",r),o.info(`\u9009\u4E2D\u503C${n}\uFF0C\u7D22\u5F15: ${t}`)},onCancel:()=>o.info("\u70B9\u51FB\u53D6\u6D88\u6309\u94AE"),onConfirm:()=>o.info("\u70B9\u51FB\u786E\u8BA4\u6309\u94AE")});const N=`import React from 'react'
...
`,R={code:N,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker, Toast } from 'react-vant-nova'
...
`,b={code:_,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker, Toast } from 'react-vant-nova'
...
`,S={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker } from 'react-vant-nova'
import { cascaderData } from './data'
...
`}},key:"picker-cascader",meta:{title:"\u7EA7\u8054\u9009\u62E9",card:!0}},$={\u6D59\u6C5F:["\u676D\u5DDE","\u5B81\u6CE2","\u6E29\u5DDE","\u5609\u5174","\u6E56\u5DDE"],\u798F\u5EFA:["\u798F\u5DDE","\u53A6\u95E8","\u8386\u7530","\u4E09\u660E","\u6CC9\u5DDE"]};async function T(n){return new Promise(r=>setTimeout(r,n))}async function L(n){return await T(1e3),$[n]}var v=()=>{const[n,r]=d.useState(!1),[t,E]=d.useState(),[i,x]=d.useState([{text:"\u6D59\u6C5F",children:[]},{text:"\u798F\u5EFA",children:[]}]);return u(f,{children:u(c,{loading:n,value:t,columns:i,onChange:async F=>{const l=F[0];if(!l)return;if(i.some(a=>a.text===l&&a.children.length>0)){E(F);return}r(!0);const k=await L(l);r(!1),x(a=>a.map(h=>h.text===l?{...h,children:k.map(s=>({text:s,value:s}))}:h))}})})};const I=`import React from 'react'
import { Picker } from 'react-vant-nova'
...
`,q={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker } from 'react-vant-nova'
...
`,z={code:j,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker } from 'react-vant-nova'
...
`,G={code:H,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Picker, Field } from 'react-vant-nova'
...
`,K={code:J,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker } from 'react-vant-nova'
import { fieldNamesData } from './data'
