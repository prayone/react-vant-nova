import{a as u,R as d,F as k,r as g,j as e}from"./main.7a53fb72.js";import{aa as c,H as o,w as y}from"./FloatingPanel.c7f80ee3.js";const P=[{text:"\u5357\u4EAC",value:0},{text:"\u82CF\u5DDE",value:1},{text:"\u5E38\u5DDE",value:2},{text:"\u6DEE\u5B89",value:3},{text:"\u626C\u5DDE",value:4},{text:"\u5357\u901A",value:5},{text:"\u5BBF\u8FC1",value:6},{text:"\u6CF0\u5DDE",value:7},{text:"\u65E0\u9521",value:8},{text:"\u957F\u6C99",value:9}];var D=()=>u(c,{title:"\u57FA\u7840\u4F7F\u7528",columns:P,onChange:(n,r,t)=>{console.log("\u9009\u4E2D\u9879: ",r),o.info(`\u9009\u4E2D\u503C${n}\uFF0C\u7D22\u5F15: ${t}`)},onCancel:()=>o.info("\u70B9\u51FB\u53D6\u6D88\u6309\u94AE"),onConfirm:()=>o.info("\u70B9\u51FB\u786E\u8BA4\u6309\u94AE")});const N=`import React from 'react'
...
`,R={code:N,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker, Toast } from 'react-vant-nova'
...
`,b={code:_,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker, Toast } from 'react-vant-nova'
...
`,S={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker } from 'react-vant-nova'
import { cascaderData } from './data'
...
`,q={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker } from 'react-vant-nova'
...
`,z={code:j,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker } from 'react-vant-nova'
...
`,G={code:H,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Picker, Field } from 'react-vant-nova'
...
`,K={code:J,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Picker } from 'react-vant-nova'
import { fieldNamesData } from './data'
