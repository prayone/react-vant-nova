import{a as u,j as e}from"./main.929296ee.js";import{dR as d}from"./TreeSelect.6eee9680.js";const i=Array.from({length:3},(n,r)=>r+1);var c=()=>u("div",{className:"demo-tabs",children:[e(d,{defaultActive:2,children:i.map(n=>u(d.TabPane,{title:`\u6807\u7B7E${n}`,children:["\u4E0B\u5212\u7EBF\u6807\u7B7E\u9875 ",n]},n))}),e(d,{border:!0,type:"capsule",children:i.map(n=>u(d.TabPane,{title:`\u6807\u7B7E${n}`,children:["\u80F6\u56CA\u6807\u7B7E\u9875 ",n]},n))}),e(d,{border:!0,type:"jumbo",children:i.map(n=>u(d.TabPane,{badge:n,title:`\u6807\u7B7E${n}`,description:"\u63CF\u8FF0\u5185\u5BB9",children:["\u5E26\u63CF\u8FF0\u4FE1\u606F\u7684\u6807\u7B7E\u9875 ",n]},n))}),e(d,{type:"card",children:i.map(n=>u(d.TabPane,{title:`\u6807\u7B7E${n}`,children:["\u5361\u7247\u6807\u7B7E\u9875 ",n]},n))})]});const b=`import React from 'react'
...
`,m={code:b,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Tabs } from 'react-vant-nova'
import './style.less'
...
`}},key:"tabs-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var l=()=>e("div",{className:"demo-tabs",children:e(d,{active:"c",children:["a","b","c"].map((n,r)=>u(d.TabPane,{name:n,title:`\u6807\u7B7E${r+1}`,children:["\u5185\u5BB9 ",r+1]},n))})});const E={code:`import React from 'react'
import { Tabs } from 'react-vant-nova'
