import{r as a,j as e,a as t}from"./main.af98c409.js";import{ee as u,b as h,d as s}from"./FloatingPanel.788cd8cb.js";var i=()=>{const[n,r]=a.exports.useState(1);return e(u,{value:n,onChange:r,totalItems:24,itemsPerPage:5})};const p={code:`import React, { useState } from 'react';
...
`,E={code:v,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Arrow, ArrowLeft } from '@react-vant/icons'
import { Pagination } from 'react-vant-nova'
