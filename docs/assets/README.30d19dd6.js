import{R as i,j as e,r as s,a as u}from"./main.929296ee.js";import{dm as a,j as C}from"./TreeSelect.6eee9680.js";var d=()=>{const[t,n]=i.useState(new Date);return e(a,{title:"\u9009\u62E9\u5E74\u6708\u65E5",type:"date",minDate:new Date(2020,0,1),maxDate:new Date(2025,10,1),value:t,onChange:n})};const v=`import React from 'react'
...
`,B={code:v,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`,x={code:y,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { DatetimePicker, Field } from 'react-vant-nova'
...
`}},key:"datetime-picker-popup",meta:{title:"\u542F\u7528\u5F39\u51FA\u5C42"}};var l=()=>e(a,{type:"year-month",minDate:new Date(2020,0,1),maxDate:new Date(2025,10,1),defaultValue:new Date,formatter:(t,n)=>t==="year"?`${n}\u5E74`:t==="month"?`${n}\u6708`:n});const f=`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`,k={code:f,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`}},key:"datetime-picker-yearmonth",meta:{title:"\u9009\u62E9\u5E74\u6708"}};var o=()=>{const[t,n]=i.useState(new Date);return e(a,{type:"month-day",minDate:new Date(2020,0,1),maxDate:new Date(2025,10,1),value:t,onChange:n})};const A=`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`,P={code:A,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`,g={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`}},key:"datetime-picker-time",meta:{title:"\u9009\u62E9\u65F6\u95F4"}};var E=()=>{const[t,n]=i.useState(new Date);return e(a,{type:"datetime",minDate:new Date(2020,0,1),maxDate:new Date(2025,10,1),value:t,onChange:n})};const _=`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`,R={code:_,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`}},key:"datetime-picker-datetime",meta:{title:"\u9009\u62E9\u5B8C\u6574\u65F6\u95F4"}};var F=()=>{const[t,n]=i.useState(new Date);return e(a,{type:"datehour",minDate:new Date(2020,0,1),maxDate:new Date(2025,10,1),value:t,onChange:n})};const M=`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`,V={code:M,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`}},key:"datetime-picker-datehour",meta:{title:"\u9009\u62E9\u5E74\u6708\u65E5\u5C0F\u65F6"}};var m=()=>e(a,{type:"time",minHour:"10",maxHour:"20",defaultValue:"12:00",filter:(t,n)=>t==="minute"?n.filter(r=>+r%5===0):n});const b=`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`,S={code:b,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
...
`,$={code:N,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { DatetimePicker } from 'react-vant-nova'
