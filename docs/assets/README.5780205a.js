import{a as u,F as r,j as n}from"./main.af98c409.js";import{C as e,dc as t,f as p,I as A,d9 as m}from"./FloatingPanel.788cd8cb.js";var a=()=>u(r,{children:[n(e,{title:"\u6587\u5B57\u63D0\u793A",isLink:!0,onClick:()=>t.info("\u63D0\u793A\u5185\u5BB9")}),n(e,{title:"\u52A0\u8F7D\u63D0\u793A",isLink:!0,onClick:()=>{t.loading({message:"\u52A0\u8F7D\u4E2D...",forbidClick:!0})}}),n(e,{title:"\u6210\u529F\u63D0\u793A",isLink:!0,onClick:()=>t.success("\u6210\u529F\u6587\u6848")}),n(e,{title:"\u5931\u8D25\u63D0\u793A",isLink:!0,onClick:()=>t.fail("\u5931\u8D25\u6587\u6848")})]});const B=`import React from 'react'
...
`,D={code:B,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Toast, Cell } from 'react-vant-nova'
...
`,k={code:T,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.1.0"},react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import { FireO } from '@react-vant/icons'
import React from 'react'
import { Toast, Cell, Image } from 'react-vant-nova'
...
`,y={code:f,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Toast, Cell } from 'react-vant-nova'
...
`,b={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell, Toast, Switch } from 'react-vant-nova'
import { ToastReturnType } from '../PropsType'
