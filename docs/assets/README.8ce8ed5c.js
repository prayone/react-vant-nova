import{r,a as e,F as E,j as n}from"./main.7fa1bdd8.js";import{ej as C,dg as m,ek as v,dd as g}from"./Table.5f9604fd.js";const t={id:1,condition:`\u65E0\u4F7F\u7528\u95E8\u69DB
...
`,f={code:A,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.7"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { CouponList, Popup, Toast, CouponCell } from 'react-vant-nova'
import { data, disabledDiscountCoupon, disabledCoupon } from './demo'
