import{a as e,F as i,j as u,r as a}from"./main.929296ee.js";import{C as r,dk as l,B,dd as m}from"./TreeSelect.6eee9680.js";import{h as A}from"./index.43ce8fd2.js";var c=()=>{const[n,d]=A.useSetState({text:"",tel:"",digit:"",num:"",password:""});return e(i,{children:[u(r,{children:u(l,{value:n.text,onChange:t=>d({text:t}),placeholder:"\u8BF7\u8F93\u5165\u6587\u672C",clearable:!0})}),u(r,{children:u(l,{value:n.tel,type:"tel",onChange:t=>d({tel:t}),placeholder:"\u8BF7\u8F93\u5165\u624B\u673A\u53F7"})}),u(r,{children:u(l,{value:n.digit,type:"digit",onChange:t=>d({digit:t}),placeholder:"\u8BF7\u8F93\u5165\u6574\u6570"})}),u(r,{children:u(l,{value:n.num,type:"number",onChange:t=>d({num:t}),placeholder:"\u8BF7\u8F93\u5165\u6570\u5B57"})}),u(r,{children:u(l,{value:n.password,type:"password",onChange:t=>d({password:t}),placeholder:"\u8BF7\u8F93\u5165\u5BC6\u7801"})})]})};const v=`import React from 'react'
...
`,x={code:v,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Cell, Input, hooks } from 'react-vant-nova'
...
`}},key:"input-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var h=()=>{const[n,d]=a.exports.useState("");return u(r,{children:u(l,{placeholder:"\u8BF7\u8F93\u5165\u6587\u672C",value:n,onChange:d,clearable:!0,clearTrigger:"always"})})};const D={code:`import React, { useState } from 'react';
...
};`}},key:"input-demo",meta:{title:"\u6E05\u9664\u6309\u94AE"}};var o=()=>u(r,{children:u(l,{prefix:"\u{1F481}",suffix:u(B,{size:"small",type:"primary",children:"\u53D1\u9001"}),placeholder:"\u8BF7\u8F93\u5165\u77ED\u4FE1\u9A8C\u8BC1\u7801"})});const g={code:`import React, { useState } from 'react';
...
};`}},key:"input-demo-1",meta:{title:"\u63D2\u5165\u5185\u5BB9"}};var F=()=>e(i,{children:[u(r,{children:u(l.TextArea,{placeholder:"\u591A\u884C\u8F93\u5165"})}),u(r,{style:{marginTop:10},children:u(l.TextArea,{placeholder:"\u81EA\u9002\u5E94\u9AD8\u5EA6",autoSize:!0})}),u(r,{style:{marginTop:10},children:u(l.TextArea,{placeholder:"\u6700\u5C0F\u9AD8\u5EA680\uFF0C\u6700\u5927\u9AD8\u5EA6120",autoSize:{minHeight:80,maxHeight:120}})})]});const y={code:`import React, { useState } from 'react';
import { Input, Cell } from 'react-vant-nova';
...
};`}},key:"input-demo-2",meta:{title:"\u591A\u884C\u8F93\u5165"}};var p=()=>e(i,{children:[u(r,{children:u(l,{placeholder:"\u6700\u591A\u8F93\u516510\u4E2A\u5B57\u7B26",maxLength:10,onOverlimit:()=>m.info("\u4E0D\u80FD\u8D85\u8FC710\u4E2A\u5B57\u7B26\u54E6\u{1F37A}")})}),u(r,{style:{marginTop:10},children:u(l.TextArea,{placeholder:"\u5B57\u6570\u7EDF\u8BA1",maxLength:50,showWordLimit:!0})}),u(r,{style:{marginTop:10},children:u(l.TextArea,{placeholder:"\u81EA\u5B9A\u4E49\u8F93\u51FA",showWordLimit:({currentCount:n})=>e("span",{children:["\u5DF2\u7ECF\u8F93\u5165",n,"\u4E2A\u5B57\u5566 \u270D\uFE0F"]})})})]});const f={code:`import React, { useState } from 'react';
...
};`}},key:"input-demo-3",meta:{title:"\u5B57\u6570\u7EDF\u8BA1"}};var E=()=>{const[n,d]=a.exports.useState("");return e(i,{children:[u(r,{children:u(l,{placeholder:"\u5185\u5BB9\u5267\u4E2D",value:n,onChange:d,align:"center"})}),u(r,{children:u(l,{placeholder:"\u5185\u5BB9\u53F3\u5BF9\u9F50",value:n,onChange:d,align:"right"})})]})};const I={code:`import React, { useState } from 'react';
import { Input, Cell } from 'react-vant-nova';
...
};`}},key:"input-demo-4",meta:{title:"\u5BF9\u9F50\u65B9\u5F0F"}};var C=()=>{const[n,d]=a.exports.useState("\u53EA\u8BFB\u6A21\u5F0F"),[t,s]=a.exports.useState("\u7981\u7528\u6A21\u5F0F");return e(i,{children:[u(r,{children:u(l,{value:n,onChange:d,readOnly:!0})}),u(r,{children:u(l,{value:t,onChange:s,disabled:!0})})]})};const b={code:`import React, { useState } from 'react';
import { Input, Cell } from 'react-vant-nova';
