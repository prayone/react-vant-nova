import{a as n,j as e}from"./main.7a53fb72.js";import{az as c,aA as a,Z as u,N as h,ad as l,r as o,aB as F,a6 as E,aC as p}from"./FloatingPanel.c7f80ee3.js";var d=()=>n("div",{children:e(c,{anchors:[170,320,window.innerHeight*.8],children:[n(a,{}),e(u,{gutter:8,children:[n(u.Item,{icon:n(h,{}),onClick:()=>0,text:"\u9644\u8FD1"}),n(u.Item,{icon:n(l,{}),onClick:()=>0,text:"\u6536\u85CF"}),n(u.Item,{icon:n(o,{}),onClick:()=>0,text:"\u8D2D\u7269\u8F66"}),n(u.Item,{icon:n(F,{}),onClick:()=>0,text:"\u4F18\u60E0"})]}),n(E,{children:"\u597D\u7269\u63A8\u8350"}),Array.from(Array(5)).map((r,t)=>n(p,{title:"\u70ED\u5356\u5546\u54C1"+t,thumb:"https://img.yzcdn.cn/vant/ipad.jpeg",desc:"\u70ED\u5356\u5546\u54C1\uFF0C\u4F18\u60E0\u540E 2.00",num:3,price:"2.00"},t))]})});const C=`import React from 'react'
import {
  ProductCard,
  Grid,
  FloatingPanel,
...
`,m={code:C,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.4"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import {
  ProductCard,
  Grid,
  FloatingPanel,
