import{r,a as u,F as d,j as e,R as F}from"./main.af98c409.js";import{C as o,df as l,aV as f}from"./FloatingPanel.788cd8cb.js";import{C as b}from"./ConfigProvider.f0db9f45.js";var h=()=>{const[t,n]=r.exports.useState(!1);return u(d,{children:[e(o,{title:"\u5C55\u793A\u5F39\u51FA\u5C42",isLink:!0,onClick:()=>n(!0)}),e(l,{visible:t,onClose:()=>n(!1),children:e("div",{style:{padding:"30px 50px"},children:"\u5185\u5BB9"})})]})};const B=`import React, { useState } from 'react'
...
`,A={code:B,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Popup, Cell } from 'react-vant-nova'
...
`,P={code:D,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Cell, Popup, PopupPosition } from 'react-vant-nova'
...
`,k={code:g,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.1.0"},react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import { Fire } from '@react-vant/icons'
import React, { useState } from 'react'
import { Popup, Cell } from 'react-vant-nova'
...
`,S={code:y,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Popup, Cell } from 'react-vant-nova'
...
`,I={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react'
import { Popup, Cell } from 'react-vant-nova'
...
`,R={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Popup, Cell, ConfigProvider } from 'react-vant-nova'
