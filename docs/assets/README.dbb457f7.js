import{r as a,j as e,a as n}from"./main.7fa1bdd8.js";import{k as l,dd as i}from"./Table.5f9604fd.js";var c=()=>{const[t,r]=a.exports.useState(10);return e(l,{value:t,onChange:r,onChangeAfter:d=>i.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const A={code:`import { useState } from 'react';
...
};`,lang:"jsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.7"},"index.jsx":{type:"FILE",value:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant-nova';
...
};`,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.2.0"},"react-vant-nova":{type:"NPM",value:"1.0.7"},"index.tsx":{type:"FILE",value:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant-nova';
