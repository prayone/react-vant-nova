import{j as e,a as r}from"./main.80adbde3.js";import{ed as u,dc as t,ch as l}from"./FloatingPanel.c796e2d9.js";var i=()=>e(u,{title:"\u6807\u9898",leftText:"\u8FD4\u56DE",rightText:"\u6309\u94AE",onClickLeft:()=>t("\u8FD4\u56DE"),onClickRight:()=>t("\u6309\u94AE")});const h={code:`import React from 'react';
...
`,o={code:a,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant-nova":{type:"NPM",value:"1.0.5"},"@react-vant/icons":{type:"NPM",value:"0.1.0"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Toast, NavBar } from 'react-vant-nova'
import { Search } from '@react-vant/icons'
